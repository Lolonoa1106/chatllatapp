            ...
            <div className="flex justify-between flex-wrap gap-10 xl:gap-32">
                <div className="max-md:w-full md:max-w-sm grow">
                  ...
                  <ul className="flex items-center flex-wrap gap-4">
                    ...
                    {/* Twitter X */}
                    <li>
                      <Link to="https://x.com/chatllat?t=lSRmMm5jPNKl8-u0369IUQ&s=09" target="_blank" className="w-10 h-10 flex items-center justify-center text-white hover:text-white bg-transparent hover:bg-primary border border-white hover:border-primary rounded-full transition-all duration-500">
                      <svg width={16} height={17} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4">
                ...
                <div className="grow flex flex-wrap justify-between gap-10">
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 font-normal tracking-wide">
                      ...
                      <li><Link to="/contact" className="text-gray-900 hover:text-white transition-colors">Contact</Link></li>
                    </ul>
                  </div>                      
                  <div className="space-y-4">
                    <div className="flex flex-col gap-1">
